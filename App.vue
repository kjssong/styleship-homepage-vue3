<template>
  <div id="wrap" :class="(buttonMode.navMode ? 'gnb--open ' : '') + (buttonMode.contactMode ? 'contact--open ' : '')">
    <!-- start of :: header -->
    <header id="header" class="header--fix">
      ...
      <nav class="gnb">
        <ul>
          ...
          <li>
            <a href="javascript:void(0);" @click="contactButton">CONTACT</a>
          </li>
        </ul>
      </nav>
      <!-- //gnb -->

      <button type="button" class="menu__btn" @click="navButton">
        <span class="t"></span>
        <span class="m"></span>
        <span class="b"></span>
      </button>
    ...
    <div class="contact__layer">
      <div class="con">
        ...
        <button type="button" class="close__btn" @click="contactButton">close</button>
        ...
        <div class="btn-box">
          ...
          <button type="button" class="send__btn" @click="contactButton">Send</button>
        </div>
      </div>
    </div>
    <!-- //contact layer -->
      ...
      <button type="button" class="contact__btn" @click="contactButton">contact</button>
		</footer>
		<!-- // end of :: footer -->
  </div>
</template>
...
const navButton = ()=>{
  buttonMode.navMode = !buttonMode.navMode
}

const contactButton = ()=>{
  buttonMode.contactMode = !buttonMode.contactMode
}
